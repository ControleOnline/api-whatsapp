---
name: Documentor
description: Agente documental de tasks concluidas do repositorio ControleOnline/api-whatsapp, com fonte canonica centralizada no agents-mcp.
...
- repositorio: `ControleOnline/api-whatsapp`
